...
insert  into `element`(`id`,`name`,`fr_name`,`image`,`detail_icon`) values 
(1,'Fire','Feu','icon-feu.png','icon-feu-bl.png'),
(2,'Water','Eau','icon-eau.png','icon-eau-bl.png'),
(3,'Wind','Vent','icon-vent.png','icon-vent-bl.png'),
(4,'Light','Lumière','icon-lumiere.png','icon-lumiere-bl.png'),
(5,'Dark','Ténèbres','icon-tenebre.png','icon-tenebre-bl.png');
...
CREATE TABLE `monsters` (
  ...
  `fr_slug` varchar(255) DEFAULT NULL,
...
insert  into `rarity`(`id`,`name`,`fr_name`,`color`) values 
(1,'Normal','Normal','#9b9b9b'),
(2,'Rare','Rare','#49e55e'),
(3,'Hero','Héroïque','#a946ff'),
(4,'Legend','Légendaire','#e59c49');
...
insert  into `role`(`id`,`name`,`fr_name`,`icon`,`detail_icon`) values 
(1,'Attack','Attaque','attaque.png',NULL),
(2,'HP','PV','pv.png',NULL),
(3,'Support','Support','support.png',NULL),
(4,'Defense','Défense','defense.png',NULL);
...
CREATE TABLE `rune_sets` (
  ...
  `rs_likes` int(10) DEFAULT 0,
  `rs_dislikes` int(10) DEFAULT 0,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`rs_id`)
...
(8,'Eleanor','Eleanor','Mystical Creature','Créature mystique','Holy Horn','Corne sacrée','Grants Reflect DMG, DEF UP II and CRIT Resist UP III on yourself.','Attribue des effets de Réflexion de dégâts, d\'Augmentation de DEF II et d\' Augmentation de RES CRIT III sur toi-même.','m_1620923371.jpeg',15,150,3093,175,0,175,15,4,'2021-05-19 11:16:47','2021-05-19 02:16:47');
...
insert  into `users`(`id`,`name`,`game_name`,`guild_name`,`email`,`email_verified_at`,`password`,`remember_token`,`role`,`verified`,`del_flag`,`created_at`,`updated_at`) values 
(1,'admin','','','admin@gmail.com',NULL,'$2y$10$2WtzC9OKoXqWAdUbNmSXSOcaut9SshFYTbJWDM96HN6zIaqN5DkvW',NULL,1,0,0,'2021-04-30 20:14:12','2021-04-30 20:14:12'),
(9,'user2','game_name_2222','guild_name_2222','user2@gmail.com',NULL,'$2y$10$2WtzC9OKoXqWAdUbNmSXSOcaut9SshFYTbJWDM96HN6zIaqN5DkvW',NULL,0,0,0,NULL,'2021-05-19 00:08:58'),
(10,'user3','game_name_3','guild_name_3','user3@gmail.com',NULL,'$2y$10$2WtzC9OKoXqWAdUbNmSXSOcaut9SshFYTbJWDM96HN6zIaqN5DkvW',NULL,0,0,0,NULL,NULL),
(11,'user4','game_name_4','guild_name_4','user4@gmail.com',NULL,'$2y$10$2WtzC9OKoXqWAdUbNmSXSOcaut9SshFYTbJWDM96HN6zIaqN5DkvW',NULL,0,0,0,NULL,NULL);
