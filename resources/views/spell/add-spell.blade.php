        ...
        <div class="tab-content">
          <div class="tab-pane active" id="account" aria-labelledby="account-tab" role="tabpanel">
            ...
            <form action="{{ route('store-spell') }}" method="POST" enctype="multipart/form-data">
              {{ csrf_field() }}
              <div class="row mt-1">
                <div class="col-12"><h5 class="mb-1"><i class="feather icon-user mr-25"></i>Add a spell</h5></div>
                <div class="col-12 col-sm-6">
                  <div class="row">
                    <div class="col-12 col-sm-6">
                      <div class="form-group">
                        <div class="controls">
                          ...
                          <input type="text" name="name" class="form-control mb-6" required placeholder="Spell Name"
                    ...
                    <div class="col-12 col-sm-6">
                      <div class="form-group">
                        <div class="controls">
                          <label></label>
                          <input type="text" name="fr_name" class="form-control mb-6" required placeholder="Spell Name"
                            data-validation-required-message="This Spell Name field is required">
                  ...
                  <div class="form-group">
                    <div class="controls">
                      <div class="d-flex">
                        <input type="text" name="fr_description" class="form-control" value=""
                          placeholder="Please input description"
                          data-validation-required-message="This Spell Description field is required">
                ...
                <div class="col-12 col-sm-6">
                  <div class="form-group">
                    <div class="controls">
                      ...
                      <input type="number" name="mana_cost" class="form-control" required placeholder="Mana Cost"
