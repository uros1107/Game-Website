...
<url>
  <loc>https://lostcenturia.gg/fr</loc>
  <lastmod>2020-10-15T17:18:25+00:00</lastmod>
</url>

<url>
  <loc>https://lostcenturia.gg/fr/monstres</loc>
  <changefreq>weekly</changefreq>
  <priority>0.9</priority>
</url>

<url>
  <loc>https://lostcenturia.gg/fr/compos</loc>
  <changefreq>weekly</changefreq>
  <priority>0.9</priority>
</url>

<url>
  <loc>https://lostcenturia.gg/fr/compos-builder</loc>
  <changefreq>weekly</changefreq>
  <priority>0.9</priority>
</url>

<url>
  <loc>https://lostcenturia.gg/fr/terms-of-use</loc>
  <changefreq>weekly</changefreq>
  <priority>0.9</priority>
</url>
...
@foreach ($monsters as $monster)
    <url>
        <loc>http://lostcenturia.gg/fr/monstres/{{ $monster->slug }}</loc>
        <image:image>
...
@foreach ($team_comps as $team_comp)
    <url>
        <loc>http://lostcenturia.gg/fr/compos/{{ $team_comp->c_slug }}</loc>
...
@foreach ($rune_sets as $rune_set)
    ...
    @endphp
    <url>
        <loc>http://lostcenturia.gg/fr/add-rune-set/{{ $monster->name }}</loc>
