                        ...
                        <div class="lost_inner_sec_left runes-selector-wrapper">
                            ...
                            <div class="lost_info">
                                ...
                                <ul>
                                    ...
                                    <li><span>@lang('monster-detail.skill_stones') : </span>{{ Session::get('lang') == 'en'? $skill_stone->skill_name : $skill_stone->fr_skill_name }}<img src="{{ asset('images/game/icons/skill-stones/'.$skill_stone->skill_icon) }}"
