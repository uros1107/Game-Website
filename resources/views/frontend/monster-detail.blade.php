                    ...
                    <div class="col-md-6">
                        <div class="lost_inner_sec_left runes-selector-wrapper">
                            ...
                            <div class="lost_info">
                                ...
                                @endphp
                                <p class="date">@lang('monster-detail.by') <span><a href="{{ route('user-public', [Session::get('lang'), $user->slug]) }}">{{ $user->name }}</a></span> @lang('monster-detail.on') {{ $rune_set->created_at->format('m/d/Y') }}</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-5">
