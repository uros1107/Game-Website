...
<div class="main-content monster-special-page" style="background-image: url({{ asset('assets/image/test-bg-champ.jpg') }}">
    ...
    <div class="monster_wrap">
        ...
        <!-- Ragdoll Section -->
        @php
            $special_monster = DB::table('special_monsters')->where('s_id', $monster->special_monster_id)->first();
        @endphp
        <div class="eleanor-section eleanor_sec monster_sec mb-50">
            <div class="row">
                <div class="col-md-7 monster_right_main">
                    <div class="monster_right_sec">
                        <div class="fury_content">
                            <p class="monster-speciality">{{ $special_monster->s_spell_name }}</p>
                            <p> {{ $special_monster->s_spell_description }}</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-5 monster_left_main">
                    <div class="monster_left_sec">
                        <div class="monster_content">
                            <div class="monster_heading">
                                <h2>{{ $special_monster->s_name }}</h2>
                                <p class="monster_sub_heading">{{ $special_monster->s_second_name }}</p>
                            </div>
                            <ul>
                                <li><span>@lang('monster-detail.rarity') : </span>{{ $rarity->name }} <span class="round-color" style="background-color:{{ $rarity->color }}"></span>
                                </li>
                                <li><span>@lang('monster-detail.role') : </span>{{ $role->name }}<img src="{{ asset('images/game/icons/roles/'.$role->icon) }}" style="width:21px" alt=""
                                        class="icons-after-text"></li>
                                <li><span>@lang('monster-detail.element') : </span>{{ $element->name }}<img src="{{ asset('images/game/icons/elements/'.$element->detail_icon) }}" style="width:14px" alt=""
                                        class="icons-after-text"></li>
                                <li><span>@lang('monster-detail.mana_cost') : </span>{{ $special_monster->s_mana_cost }}</li>
                            </ul>
                        </div>
                        ...
                        <div class="stats_info">
                            <ul class="text-left">
                                <li>
                                    ...
                                    <div class="stats_detais">
                                        <span class="basic_stats_title">@lang('monster-detail.atk')</span>
                                        <span class="basic_stats_number">{{ $special_monster->s_atk }}</span>
                                    </div>
                                </li>
                                <li>
                                    <div class="stats_icon">
                                    ...
                                    <div class="stats_detais">
                                        <span class="basic_stats_title">@lang('monster-detail.def')</span>
                                        <span class="basic_stats_number">{{ $special_monster->s_def }}</span>
                                    </div>
                                </li>
                                <li>
                                    <div class="stats_icon">
                                    ...
                                    <div class="stats_detais">
                                        <span class="basic_stats_title">@lang('monster-detail.hp')</span>
                                        <span class="basic_stats_number">{{ $special_monster->s_hp }}</span>
                                    </div>
                                </li>
                            </ul>
                            <ul class="text-left">
                                ...
                                <li>
                                    ...
                                    <div class="stats_detais">
                                        <span class="basic_stats_title">@lang('monster-detail.crit_rate')</span>
                                        <span class="basic_stats_number">{{ $special_monster->s_crit_rate }}%</span>
                                    </div>
                                </li>
                                <li>
                                    <div class="stats_icon">
                                    ...
                                    <div class="stats_detais">
                                        <span class="basic_stats_title">@lang('monster-detail.crit_dmg')</span>
                                        <span class="basic_stats_number">{{ $special_monster->s_crit_dmg }}%</span>
                                    </div>
                                </li>
                                <li>
                                    <div class="stats_icon">
                                    ...
                                    <div class="stats_detais">
                                        <span class="basic_stats_title">@lang('monster-detail.acc')</span>
                                        <span class="basic_stats_number">{{ $special_monster->s_acc }}%</span>
                                    </div>
                                </li>
                                <li>
                                    <div class="stats_icon">
                                    ...
                                    <div class="stats_detais">
                                        <span class="basic_stats_title">@lang('monster-detail.res')</span>
                                        <span class="basic_stats_number">{{ $special_monster->s_res }}%</span>
                                    </div>
                                </li>
                            </ul>
                        </div>
