                            ...
                            <div class="row desktop_block">
                                <div class="col-md-6">
                                    ...
                                    <div class="compect_plus_box">
                                        ...
                                        @endphp
                                        @if($key % 8 < 4)
                                        <a href="{{ route('monster-detail').'?id='.$c_monster->id }}" class="compect_monster_box compect_monster_box{{$key + 1}}" target="_blank">
                                ...
                                <div class="col-md-6">
                                    <div class="compect_plus_right_box">
                                        ...
                                        @endphp
                                        @if($key % 8 >= 4)
                                        <a href="{{ route('monster-detail').'?id='.$c_monster->id }}" class="compect_monster_box compect_monster_box{{$key % 4 + 1}}" target="_blank">
                                            <div class="monster_img">
                                                <div class="icon_img">
