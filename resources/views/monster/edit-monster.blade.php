              ...
              <div class="row mt-1">
                ...
                <div class="col-12 col-sm-6">
                  ...
                  <fieldset class="form-group">
                      <label for="basicInputFile">OG Image (EN)</label>
                  ...
                  <fieldset class="form-group">
                      <label for="basicInputFile">OG Image (FR)</label>
                      <div class="custom-file">
                          <input type="text" id="fr_og_img_input" class="custom-file-input">
                          <input type="file" name="fr_og_image" id="fr_og_img_hidden" class="custom-file-input d-none">
                          <label class="custom-file-label" for="inputGroupFile01">{{ $monster->fr_og_image }}</label>
                      </div>
                  </fieldset>
                  <fieldset class="form-group">
...
@section('page-script')
  <script>
    $(document).ready(function() {
      ...
      $("#fr_og_img_input").on('click', function(){
        $('#fr_og_img_hidden').click();
      })
